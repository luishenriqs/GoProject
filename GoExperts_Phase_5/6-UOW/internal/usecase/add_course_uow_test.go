...
import (
	...
	"github.com/luishenriqs/GoProject/GoExperts_Phase_5/6-UOW/internal/repository"
	"github.com/luishenriqs/GoProject/GoExperts_Phase_5/6-UOW/pkg/uow"
...
func TestAddCourseUow(t *testing.T) {
	...
	input := InputUseCase{
		...
		CourseName:       "Course 1",
		CourseCategoryID: 2, // ERRO PREVISTO EM AULA PARA GERAR INCONSISTÊNCIA E FORÇAR O ROLLBACK!
	}
